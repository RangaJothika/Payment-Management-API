...
//				Orders newOrder = orderDalImpl.getById(order.getId());
...
//			newPayment.setPaymentReviews(payment.getPaymentReviews());
//			newPayment.setOrders(ordersList);
//			paymentDAL.addPayment(newPayment);
